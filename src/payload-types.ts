...
export interface AboutUs {
  ...
  visi: string;
  /**
   * Misi perusahaan (daftar poin-poin misi, gunakan format bullet points dengan tanda "-" di awal setiap baris)
   */
  misi: string;
  /**
   * Cover image for Struktur Organisasi section (landscape, full width)
   */
  strukturOrganisasiCover?: (number | null) | Media;
  /**
   * Organizational structure chart image
   */
  strukturOrganisasiImage?: (number | null) | Media;
  updatedAt: string;
  createdAt: string;
}
/**
...
export interface Video {
  ...
  title: string;
  /**
   * Short description of the video (optional)
   */
...
export interface AboutUsSelect<T extends boolean = true> {
  ...
  visi?: T;
  misi?: T;
  strukturOrganisasiCover?: T;
  strukturOrganisasiImage?: T;
  updatedAt?: T;
  createdAt?: T;
}
/**
